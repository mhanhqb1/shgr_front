...
<div class="container content">
        ...
        <p align="center" class="legal_doc_title" style="text-align:left;font-weight:bold;font-size:18px;color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;background-color:#FFFFFF;">
	<strong>1. GIỚI THIỆU</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	1.1 Website&nbsp;<a href="http://www.chotreo.com/">http://www.chotreo.com</a>&nbsp;được điều hành bởi Công ty TNHH ChoTreo, các chi nhánh trực thuộc và các tổ chức liên quan (được gọi riêng là "ChoTreo", và gọi chung là "Chúng tôi", “của Chúng tôi” trong văn bản này). ChoTreo cam kết tôn trọng quyền riêng tư và những vấn đề cá nhân của tất cả Người Dùng trên trang chủ ChoTreo ("Trang web”) (Chúng tôi gọi chung Trang web và các dịch vụ Chúng tôi cung cấp được mô tả trên Trang web là “Dịch Vụ”). Chúng tôi nhận thức được tầm quan trọng của các dữ liệu cá nhân mà bạn đã giao phó cho Chúng tôi và tin rằng trách nhiệm của Chúng tôi là quản lý đúng cách, bảo vệ và xử lý dữ liệu cá nhân của bạn. Chính Sách Bảo Mật này (gọi tắt là "Chính Sách Bảo Mật" hay "Chính Sách") được tạo ra nhằm cung cấp các thông tin tổng quát về việc Chúng tôi sẽ thu thập, sử dụng, tiết lộ hoặc xử lý các dữ liệu cá nhân mà bạn đã cung cấp cho Chúng tôi như thế nào, cho dù ở hiện tại hay trong tương lai; cũng như cách mà Chúng tôi sẽ hỗ trợ bạn trước khi đưa ra bất cứ quyết định nào liên quan đến việc cung cấp dữ liệu cá nhân của bạn cho Chúng tôi. Xin vui lòng đọc Chính Sách Bảo Mật một cách cẩn thận. Nếu bạn có bất kỳ câu hỏi liên quan đến các thông tin này hoặc thực tiễn bảo mật của Chúng tôi, xin vui lòng xem phần "Thắc mắc? Liên hệ với Chúng tôi" ở phần cuối của Chính Sách Bảo Mật này.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	1.2 Bằng cách sử dụng Dịch Vụ, đăng ký tài khoản với Chúng tôi, ghé thăm Trang web của Chúng tôi, hoặc truy cập vào Dịch vụ, bạn đã thừa nhận và đồng ý các yêu cầu, và/hoặc các Chính Sách, thực tiễn áp dụng nêu trong Chính Sách Bảo Mật này, và bạn đồng ý với Chúng tôi về việc thu thập, sử dụng, tiết lộ và/hoặc xử lý dữ liệu cá nhân của bạn theo cách được mô tả trong tài liệu này. NẾU BẠN KHÔNG ĐỒNG Ý VỚI CHÍNH SÁCH BẢO MẬT NÀY, VUI LÒNG KHÔNG SỬ DỤNG DỊCH VỤ CỦA CHÚNG TÔI HOẶC TRUY CẬP WEBSITE CỦA CHÚNG TÔI. Nếu Chúng tôi thay đổi Chính Sách Bảo Mật, Chúng tôi sẽ cập nhật thay đổi hoặc sửa đổi đó trên Trang web của Chúng tôi. Chúng tôi bảo lưu quyền sửa đổi Chính Sách Bảo Mật này vào bất cứ lúc nào.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>2. CHOTREO THU THẬP NHỮNG THÔNG TIN GÌ?</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	2.1 "Dữ liệu cá nhân" được định nghĩa là dữ liệu, dù đúng hay sai, về một cá nhân - người mà có thể được xác định danh tính từ dữ liệu đó, hoặc từ dữ liệu và các thông tin khác mà một tổ chức có quyền hoặc có thể truy cập. Ví dụ thường gặp của dữ liệu cá nhân có thể bao gồm: Họ tên, số CMND và thông tin liên lạc.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<u>Lưu ý:</u>&nbsp;Thông tin bạn cung cấp cần phải chính xác, vì nó liên quan đến việc vận chuyển của hàng hóa, thanh toán hoặc bồi hoàn.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	2.2 Chúng tôi sẽ/có thể sẽ thu thập thông tin cá nhân về bạn:
</p>
<div class="blockquote" style="padding:10px 50px 10px 20px;color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<p>
		(a) Khi bạn đăng ký và/hoặc sử dụng dịch vụ hoặc Trang web của Chúng tôi, hoặc mở một tài khoản với Chúng tôi;
	</p>
	<p>
		(b) Khi bạn gửi bất kỳ biểu mẫu nào, bao gồm nhưng không giới hạn đơn đăng ký hoặc các mẫu đơn khác liên quan đến bất kỳ sản phẩm và dịch vụ của Chúng tôi, cho dù trực tuyến hoặc bằng một hình thức chuyển phát khác;
	</p>
	<p>
		(c) Khi bạn đồng ý bất kỳ thỏa thuận nào hoặc cung cấp cho Chúng tôi tài liệu hoặc thông tin liên quan đến tương tác giữa bạn với Chúng tôi, hoặc khi bạn sử dụng các sản phẩm và dịch vụ của Chúng tôi;
	</p>
	<p>
	...
	<p>
		(e) Khi bạn sử dụng dịch vụ điện tử của Chúng tôi, hoặc tương tác với Chúng tôi qua ứng dụng, hoặc sử dụng các dịch vụ trên Trang web của Chúng tôi. Điều này bao gồm thông qua các tập tin Cookie mà Chúng tôi có thể triển khai khi bạn tương tác với các ứng dụng hoặc Trang web của Chúng tôi;
	</p>
	<p>
...
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	2.6 Nếu bạn không muốn Chúng tôi thu thập các thông tin nói trên hay dữ liệu cá nhân, bạn có thể chọn không tham gia bất cứ lúc nào bằng cách thông báo đến Bộ phận Chăm sóc khách hàng của Chúng tôi.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<u>Lưu ý:</u>&nbsp;Khi bạn không tham gia hoặc không còn đồng ý với các điều khoản thu thập thông tin cá nhân của Chúng tôi, việc sử dụng Dịch vụ của bạn có thể sẽ bị ảnh hưởng. Ví dụ như dịch vụ xác định vị trí sẽ không hoạt động nếu bạn không cho phép ứng dụng truy cập vị trí của bạn.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>3. CÀI ĐẶT TÀI KHOẢN</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	Một số chức năng nhất định của Dịch Vụ yêu cầu bạn sẽ phải tạo một tài khoản Người Dùng và gửi dữ liệu cá nhân. Khi bạn đăng ký và tạo một tài khoản mới, Chúng tôi yêu cầu bạn cung cấp cho Chúng tôi những thông tin như họ tên, địa chỉ email, và tên Người Dùng mà bạn chọn. Chúng tôi cũng yêu cầu một số thông tin cá nhân như số điện thoại, địa chỉ email, địa chỉ nhận hàng, số CMND, chi tiết tài khoản ngân hàng, tuổi, ngày sinh, giới tính và sở thích. Sau khi kích hoạt tài khoản, bạn sẽ chọn một tên Người Dùng và mật khẩu. Tên Người Dùng và mật khẩu của bạn sẽ được sử dụng để bạn có thể truy cập một cách an toàn và duy trì tài khoản của bạn.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>4. TRUY CẬP TRANG WEB</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
...
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	5.1 Chúng tôi có thể sử dụng "Cookies" hoặc các tính năng khác để cho phép Chúng tôi hoặc các bên thứ ba thu thập hoặc chia sẻ những thông tin qua đó giúp Chúng tôi cải thiện Trang web và các Dịch vụ Chúng tôi cung cấp, hoặc giúp Chúng tôi cung cấp dịch vụ và tính năng mới. "Cookies" là những định danh Chúng tôi chuyển đến máy tính hoặc thiết bị di động của bạn cho phép Chúng tôi nhận ra máy tính hoặc thiết bị của bạn và cho Chúng tôi biết làm thế nào và khi nào các Dịch vụ hoặc Trang web của Chúng tôi được sử dụng hay truy cập, bởi bao nhiêu người và theo dõi các thao tác được thực hiện trên Trang web của Chúng tôi. Chúng tôi có thể liên kết các thông tin cookie đến các dữ liệu cá nhân. Cookies cũng thu thập thông tin liên quan đến những gì các bạn đã cho vào giỏ hàng và các trang bạn đã xem. Ngoài ra, Cookies còn được sử dụng để cung cấp những nội dung liên quan đến sở thích của bạn và theo dõi việc sử dụng Trang web.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	5.2 Bạn có thể từ chối việc sử dụng các Cookie bằng cách chọn các thiết lập thích hợp trên trình duyệt. Tuy nhiên, xin vui lòng lưu ý rằng nếu bạn làm điều này bạn có thể không có khả năng sử dụng các chức năng đầy đủ của Trang web hoặc Dịch Vụ của Chúng tôi.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>6. XEM, TẢI NỘI DUNG VÀ QUẢNG CÁO</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	Giống như khi duyệt web bằng trình duyệt, khi bạn xem nội dung quảng cáo, truy cập các phần mềm khác trên Trang web hoặc thông qua các dịch vụ của Chúng tôi , hầu hết các thông tin sẽ được gửi cho Chúng tôi (bao gồm địa chỉ IP, hệ điều hành...); tuy nhiên, thay vì số lượt truy cập, máy tính của bạn sẽ gửi cho Chúng tôi thông tin về nội dung, quảng cáo đã xem và/hoặc phần mềm được cài đặt bởi Trang web và Dịch vụ của Chúng tôi.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>7. CỘNG ĐỒNG &amp; HỖ TRỢ</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	7.1 Chúng tôi cung cấp dịch vụ hỗ trợ khách hàng qua email, tin nhắn SMS và các hình thức tương tác khác. Để hỗ trợ khách hàng, Chúng tôi sẽ yêu cầu khách hàng cung cấp địa chỉ email và số điện thoại di động. Ngoài ra, Chúng tôi không yêu cầu bất kỳ dữ liệu cá nhân nào khác thì mới cung cấp dịch vụ hỗ trợ khách hàng. Chúng tôi chỉ sử dụng thông tin nhận được khi khách hàng yêu cầu hỗ trợ, trong đó bao gồm địa chỉ email để hỗ trợ khách hàng và Chúng tôi sẽ không chuyển hoặc chia sẻ thông tin này với bất kỳ bên thứ ba nào khác.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	7.2 Bạn cũng có thể gửi câu hỏi và trả lời các câu hỏi của những Người Dùng khác qua tính năng “Tán gẫu” (Chat) hoặc “Bình luận” của Chúng tôi. Diễn đàn và dịch vụ trò chuyện của Chúng tôi cho phép bạn tham gia vào cộng đồng của Chúng tôi; và khi làm như vậy, Chúng tôi lưu trữ thông tin như ID Người Dùng, danh sách liên lạc và trạng thái tin nhắn của bạn. Ngoài ra, các dịch vụ tương tự trong tương lai có thể yêu cầu Chúng tôi lưu trữ ID Người Dùng và mật khẩu của bạn.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>8. KHẢO SÁT NGƯỜI DÙNG</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
...
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>9. CHÚNG TÔI SỬ DỤNG THÔNG TIN BẠN CUNG CẤP NHƯ THẾ NÀO?</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	9.1 Chúng tôi có thể thu thập, sử dụng, tiết lộ và/hoặc xử lý dữ liệu cá nhân của bạn cho một hoặc nhiều hơn các Mục Đích sau đây:
</p>
<div class="blockquote" style="padding:10px 50px 10px 20px;color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<p>
	...
	<p>
		(b) Để quản lý, vận hành, cung cấp và/hoặc quản trị việc sử dụng và/hoặc truy cập vào Dịch Vụ hay Trang web của Chúng tôi, cũng như tài khoản Người Dùng của bạn và mối quan hệ với Chúng tôi;
	</p>
	<p>
	...
	<p>
		(m) Để tiến hành nghiên cứu, phân tích và phát triển Dịch Vụ (bao gồm phân tích dữ liệu, làm khảo sát, xây dựng và/hoặc phát triển sản phẩm và dịch vụ), để phân tích hành vi Người Dùng nhằm Mục Đích cải thiện Dịch Vụ hoặc sản phẩm của Chúng tôi và/hoặc để cải thiện trải nghiệm của Người Dùng;
	</p>
	<p>
		(n) Để cho phép quảng cáo, kiểm toán và các cuộc khảo sát khác nhằm xác định qui mô và thành phần đối tượng mục tiêu của bạn, và hiểu sở thích của họ với các Dịch vụ của ChoTreo;
	</p>
	<p>
		(o) Dành cho Mục Đích tiếp thị, Chúng tôi sẽ gửi thông tin cho bạn theo các phương tiện liên lạc khác nhau như thư bưu chính, thư điện tử, dịch vụ dựa trên vị trí, thông tin khuyến mại và các tài liệu liên quan đến các sản phẩm và/hoặc dịch vụ (bao gồm cả các sản phẩm và/hoặc dịch vụ của các bên thứ ba mà ChoTreo cộng tác hay làm việc với) mà ChoTreo (và/hoặc các chi nhánh trực thuộc hoặc tổ chức liên quan) đang bán, tiếp thị hay quảng bá, cho dù sản phẩm hay dịch vụ đó đang tồn tại hoặc sẽ được tạo ra trong tương lai. Chúng tôi sẽ không gửi tiếp thị hoặc các thông tin khuyến mại cho bạn qua cuộc gọi, tin nhắn SMS/MMS hoặc fax, trừ khi điều đó không vi phạm các qui định pháp luật hoặc trước đó Chúng tôi đã nhận được sự đồng ý một cách rõ ràng từ phía bạn;
	</p>
	<p>
		(p) Để sử dụng vào các vụ việc tố tụng hoặc để tuân thủ hoặc đáp ứng qui định pháp luật hoặc thực hiện theo yêu cầu của chính quyền hoặc quy định của bất kỳ cơ quan thẩm quyền có liên quan, trong đó có bao gồm việc công bố thông tin theo yêu cầu của pháp luật mà ChoTreo hoặc chi nhánh, công ty có liên quan với ChoTreo cam kết ràng buộc;
	</p>
	<p>
		(q) Để thu thập số liệu thống kê và nghiên cứu báo cáo nội bộ theo luật định và/hoặc yêu cầu lưu giữ hồ sơ;
	</p>
	<p>
		(r) Để thực hiện các hoạt động sàng lọc nội dung (bao gồm kiểm tra lý lịch Người Dùng) theo quy định của pháp luật và quy định của ChoTreo;
	</p>
	<p>
		(s) Để kiểm toán Dịch Vụ hoặc hoạt động kinh doanh của ChoTreo;
	</p>
	<p>
		(t) Để ngăn ngừa hoặc điều tra mọi gian lận, hoạt động trái pháp luật, thiếu sót hay hành vi sai trái, cho dù có liên quan đến việc bạn sử dụng Dịch vụ của Chúng tôi hoặc bất kỳ vấn đề nào khác phát sinh từ mối liên hệ của bạn với Chúng tôi, dù có hoặc không có bất kỳ nghi ngờ nào về các hành vi nói trên;
	</p>
	<p>
	...
	<p>
		(v) Để xử lý hoặc để thuận tiện cho các giao dịch liên quan đến tài sản kinh doanh mà ChoTreo là một bên tham gia hoặc có liên quan đến chi nhánh trực thuộc hoặc tổ chức có liên quan với tư cách là bên tham gia hoặc liên quan đến ChoTreo và/hoặc một hoặc nhiều chi nhánh/tổ chức liên quan của ChoTreo với tư cách là các bên tham gia và có thể sẽ có thêm một bên tham gia là một tổ chức thứ ba. “Giao dịch tài sản kinh doanh” được hiểu là các giao dịch mua bán, cho thuê, sáp nhập, hợp nhất hoặc mua lại một tổ chức/một phần của một tổ chức hoặc bất cứ tài sản nào của tổ chức đó;
	</p>
	<p>
...
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>12. CHOTREO CÓ TIẾT LỘ THÔNG TIN CÁ NHÂN CỦA BẠN RA BÊN NGOÀI KHÔNG?</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	12.1 Trong hoạt động kinh doanh của Chúng tôi, Chúng tôi sẽ/có thể cần phải tiết lộ dữ liệu cá nhân của bạn cho bên thứ ba là các bên cung cấp dịch vụ cho Chúng tôi. Chúng tôi, đại lý và/hoặc các chi nhánh của Chúng tôi hoặc các công ty liên quan, và/hoặc các bên thứ ba khác, cho dù các Trang web bên đó đặt tại đâu, cho một hoặc nhiều hơn các Mục Đích nêu trên. Các nhà cung cấp dịch vụ, đại lý và/hoặc các chi nhánh hoặc công ty liên quan và/hoặc các bên thứ ba khác đó sẽ được thay mặt Chúng tôi hoặc bằng cách khác, xử lý dữ liệu cá nhân của bạn cho một hoặc nhiều hơn các Mục Đích nêu trên. Các bên thứ ba đó bao gồm:
</p>
<div class="blockquote" style="padding:10px 50px 10px 20px;color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<p>
...
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	12.2 Ngoài các nội dung trên, việc chia sẻ thông tin này có thể là do yêu cầu về việc chia sẻ thông tin mang tính thống kê và nhân khẩu học về Người Dùng của Chúng tôi và việc sử dụng Dịch Vụ của họ với các nhà cung cấp dịch vụ quảng cáo và lập trình. Điều này sẽ không bao gồm bất cứ điều gì mà có thể được sử dụng để nhận dạng bạn một cách đặc biệt hoặc để phát hiện các thông tin cá nhân về bạn.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	12.3 Để tránh sự nghi ngờ, trong trường hợp pháp luật bảo vệ dữ liệu cá nhân hoặc các điều luật khác cho phép một tổ chức như Chúng tôi thu thập, sử dụng hoặc tiết lộ dữ liệu cá nhân của bạn mà không cần sự đồng ý của bạn, thì sự cho phép đó vẫn tiếp tục được áp dụng.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	12.4 Chính Sách Bảo Mật này không phải là một lời hứa rằng dữ liệu cá nhân của bạn sẽ không bao giờ được tiết lộ, ngoại trừ như được mô tả trong Chính Sách Bảo Mật này. Ví dụ, các bên thứ ba bất hợp pháp có thể chặn truy cập dữ liệu cá nhân chuyển đến hoặc được chứa trên Trang web, công nghệ có thể không hoạt động hoặc hoạt động không như dự kiến, hoặc một người nào đó có thể truy cập, lạm dụng hoặc sử dụng thông tin sai cách mà không phải do lỗi của Chúng tôi. Chúng tôi sẽ luôn triển khai các biện pháp an ninh hợp lý để bảo vệ dữ liệu cá nhân của bạn theo quy định pháp luật hiện hành; tuy nhiên có thể sẽ không đảm bảo an toàn tuyệt đối khỏi việc tiết lộ trái phép phát sinh từ hành động hacking mang tính phá hoại và tinh vi bởi các đối tượng bất mãn chứ không phải do lỗi của Chúng tôi.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>13. THÔNG TIN VỀ TRẺ EM</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	Các Dịch Vụ không dành cho trẻ em dưới 10 tuổi. Chúng tôi không thu thập hoặc duy trì bất kỳ dữ liệu cá nhân hoặc thông tin không nhận dạng cá nhân từ bất cứ ai dưới 10 tuổi, và bất kỳ phần nào của Trang web của Chúng tôi hoặc dịch vụ khác cũng không dành cho trẻ em ở độ tuổi dưới 10. Chúng tôi sẽ khóa bất kỳ tài khoản nào sử dụng hoàn toàn bởi đối tượng trẻ em như vậy và sẽ loại bỏ và/hoặc xóa bất kỳ dữ liệu cá nhân nào mà Chúng tôi tin là đã được gửi đi bởi trẻ em dưới 10 tuổi.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>14. THÔNG TIN THU THẬP CỦA BÊN THỨ BA</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
...
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	17.2.4 Không kể đến điều (b) ở trên, nếu bạn yêu cầu, Chúng tôi có thể gửi các dữ liệu cá nhân đã chỉnh sửa chỉ cho các tổ chức cụ thể mà Chúng tôi đã tiết lộ các dữ liệu cá nhân này trong vòng 1 năm trước ngày điều chỉnh được thực hiện.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	17.2.5 Chúng tôi sẽ/có thể tính một mức phí hợp lý cho việc xử lý các yêu cầu truy cập vào dữ liệu cá nhân của bạn. Nếu Chúng tôi quyết định thu phí, Chúng tôi sẽ cung cấp cho bạn một ước tính bằng văn bản về việc tính phí. Xin lưu ý rằng Chúng tôi không cần phải trả lời hoặc xử lý với yêu cầu truy cập của bạn, trừ khi bạn đã đồng ý trả tiền lệ phí.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	17.2.6 Chúng tôi bảo lưu quyền từ chối chỉnh sửa dữ liệu cá nhân của bạn dựa theo với các quy định đã nêu trong các luật liên quan, luật yêu cầu và/hoặc cho phép một tổ chức từ chối chỉnh sửa dữ liệu cá nhân trong một số trường hợp quy định.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>18. CÂU HỎI, THẮC MẮC HOẶC KHIẾU NẠI? LIÊN HỆ VỚI CHÚNG TÔI</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	18.1 Nếu bạn có bất kỳ câu hỏi hoặc quan tâm về việc bảo mật của Chúng tôi hoặc các giao dịch của bạn với các Dịch Vụ, xin vui lòng liên hệ:<a href="mailto:support@chotreo.com" target="_blank">support@chotreo.com</a> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	18.2 Nếu bạn có bất kỳ khiếu nại liên quan đến cách Chúng tôi đang xử lý dữ liệu cá nhân của bạn hoặc về cách thức Chúng tôi đang thực thi luật, Chúng tôi hoan nghênh bạn liên hệ với Chúng tôi.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	Hãy liên hệ với Chúng tôi qua email với đơn khiếu nại của bạn:
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	E-mail:&nbsp;<a href="mailto:support@chotreo.com">support@chotreo.com</a> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	18.3 Nếu bạn gửi yêu cầu khiếu nại thông qua thư hay email, vui lòng ghi thông tin vụ khiếu nại về việc áp dụng luật liên quan đến an toàn thông tin cá nhân ở mục tiêu đề thư. Việc này sẽ giúp Chúng tôi xử lý yêu cầu của bạn nhanh chóng bằng cách chuyển yêu cầu đó sang bộ phận chịu trách nhiệm trong công ty Chúng tôi để tiếp tục xử lý. Ví dụ, bạn có thể thêm vào mục tiêu đề email/thư nội dung “Khiếu nại áp dụng luật”.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	Chúng tôi sẽ cố gắng để xử lí các phàn nàn hoặc khiếu nại của bạn trong thời gian sớm nhất có thể.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>19</strong>&nbsp;<strong>. LUẬT ĐIỀU CHỈNH</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	Chính Sách Bảo Mật này được điều chỉnh bởi pháp luật của nước Cộng hòa Xã hội chủ nghĩa Việt Nam.
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
	<strong>2</strong>&nbsp;<strong>0</strong>&nbsp;<strong>. CÁC ĐIỀU KHOẢN VÀ ĐIỀU KIỆN</strong> 
</p>
<p style="color:#535258;font-family:'B Koodak', 'X Koodak', Koodak, Arial;font-size:16px;background-color:#FFFFFF;">
